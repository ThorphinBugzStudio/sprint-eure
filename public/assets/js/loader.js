window.addEventListener("load", function () {
   ...
   //  console.log(document.getElementById('view').offsetWidth);
   //  console.log(document.getElementById('view').offsetHeight);

    var w = document.getElementById('view').offsetWidth, h = 500;
    ...
    // 3em parametre pour distance camera ?.
