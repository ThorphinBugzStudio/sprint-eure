...
<form class="" action="<?php $this->url('password_modify_action') ?>" method="POST">
  <div class="row mx-auto mt-4" style="max-width: 300px;">
    ...
    <input class="input-form" type="text" name="newpassword" value="<?php if(!empty($_POST['newpassword'])){ echo $_POST['newpassword']; } ?>">
  ...
  <div class="row mx-auto" style="max-width: 300px;">
    ...
    <input class="input-form" type="text" name="newpassword-confirm" value="<?php if(!empty($_POST['newpassword-confirm'])){ echo $_POST['newpassword-confirm']; } ?>">
  </div>
